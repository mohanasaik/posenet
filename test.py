...
path = 'C:\\Users\\mohan\\OneDrive\\Desktop\\DATA\\posenet\\KingsCollege\\'
...
def main():
	...
	with tf.Session() as sess:
		...
		for i in range(len(datasource.images)):
			...
			RMSE = np.sqrt(mean_squared_error(q1,q2))
			print ('Iteration:', i,'Error XYZ (m):',error_x,'Error Q (degrees):',theta,'Rsquare error:',r2_score(q1, q2),'RMSE:',RMSE)
